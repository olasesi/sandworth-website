...
define('SITE_URL', 'http://localhost/sandworth');
...
<head>
  ...
  <link rel="icon" href="<?= SITE_URL ?>/images/logo.jpg" type="image/jpeg"/>
...
<header id="site-header">
  <div class="header-inner">
    <a class="logo" href="<?= SITE_URL ?>/">
      <img src="<?= SITE_URL ?>/images/sandworth.png" alt="Sandworth Properties Ltd." class="logo-img"/>
    </a>
