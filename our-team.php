<?php
$page_title   = 'Our Team — Expert Real Estate Professionals';
$meta_desc    = 'Meet the Sandworth Properties leadership team — decades of combined expertise in Nigerian real estate, finance, law, and property management.';
$current_page = 'our-team';
$og_image     = './images/arepo-slider-1024x598.png';
require './partials/header.php';
?>

<section class="page active" id="page-team">

  <div class="page-hero">
    <div class="page-hero-bg ph-team"></div>
    <div class="page-hero-content">
      <div class="sec-tag light">The People Behind Sandworth</div>
      <h1>Meet Our<br><em>Expert Team</em></h1>
      <p>Leadership built on decades of experience and a shared passion for excellence.</p>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="sec-head-row">
      <h2>Guided by Experience,<br>Driven by Passion</h2>
      <p>Our leadership brings together decades of expertise in real estate, finance, law, and architecture.</p>
    </div>
    <div class="team-grid">
      ...
      <div class="tcard reveal" style="--d:.4s">
        ...
        <div class="tcard-body">
          <h4>Joan Usman</h4>
          <span class="trole">Legal Counsel &amp; Head of Compliance</span>
